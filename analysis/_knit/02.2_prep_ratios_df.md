...
![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-4-1.png)<!-- -->
...
![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-5-1.png)<!-- -->
...
![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-6-1.png)<!-- -->
...
![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-7-1.png)<!-- -->
...
![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-8-1.png)<!-- -->
...
```
## Warning: Removed 1789 rows containing missing values (`geom_point()`).
```

![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-9-1.png)<!-- -->
...
![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-11-1.png)<!-- -->
...
![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-16-1.png)<!-- -->
...
![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-16-2.png)<!-- -->
...
![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-17-1.png)<!-- -->
...
![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-18-1.png)<!-- -->
...
```
## # A tibble: 1,789 × 7
## # Groups:   county, race, sex [995]
##    county  race   sex age_grp n_enrollees n_admissions obs_rate
##     <dbl> <dbl> <dbl> <chr>         <dbl>        <dbl>    <dbl>
##  1   4011     2     1 >85               0            0      NaN
##  2   4011     2     2 >85               0            0      NaN
##  3   5009     2     1 >85               0            0      NaN
##  4   5065     2     1 >85               0            0      NaN
##  5   5065     2     2 >85               0            0      NaN
##  6   5101     2     1 >85               0            0      NaN
##  7   5101     2     2 [75,85)           0            0      NaN
##  8   5113     2     1 >85               0            0      NaN
##  9   5113     2     2 >85               0            0      NaN
## 10   5127     2     2 [75,85)           0            0      NaN
## # ℹ 1,779 more rows
```
...
![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-21-1.png)<!-- -->
...
![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-22-1.png)<!-- -->
...
![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-23-1.png)<!-- -->
...
![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-27-1.png)<!-- -->
...
![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-28-1.png)<!-- -->
...
![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-29-1.png)<!-- -->
...
![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-30-1.png)<!-- -->
...
![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-30-2.png)<!-- -->
...
![](./02.2_prep_ratios_df_files/figure-html/unnamed-chunk-31-1.png)<!-- -->
