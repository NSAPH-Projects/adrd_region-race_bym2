...
new_stan_file <- paste0('results/models/m0/model_run_', tstamp, '/m_', tstamp, '.stan')
file.copy(stan_file, 
          new_stan_file)
...
## Save fit objects ----
write_rds(fit, 
          paste0('results/models/m0/model_run_', 
                 tstamp, 
                 '/stanfit_object.rds'))
...
file.remove(paste0('results/models/m0/model_run_', tstamp, '/m_', tstamp, '.rds'))
