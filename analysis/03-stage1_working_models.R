...
adrd_stage1 <- paste0("results/models/stage1/adrd/", 
                       c("m1/model_run_20240422-184005/stanfit_object_stage1_adrd_m1.rds",
                         "m2/model_run_20240422-184103/stanfit_object_stage1_adrd_m2.rds",
                         "m3/model_run_20240422-184103/stanfit_object_stage1_adrd_m3.rds"))

hosp_stage1 <- paste0("results/models/stage1/hosp/",
                      c("m1/model_run_20240422-184103/stanfit_object_stage1_hosp_m1.rds",
                        "m2/model_run_20240422-184103/stanfit_object_stage1_hosp_m2.rds",
                        "m3/model_run_20240422-184103/stanfit_object_stage1_hosp_m3.rds"))
