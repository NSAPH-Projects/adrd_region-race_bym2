...
stanfit_object <- read_rds("results/models/m0/model_run_20231109_142035/stanfit_object.rds")
...
# which columns (counties) have risk ratios significantly different from zero?
...
# is phi (shared, unscaled) for each county significantly different from 1?
phi_sig <- data.frame(
    shared_unscaled_sig = 
...
# is psi for each county for each race significantly different from 1?
psi_sig <- rbind(
  tibble(
    race = 1,  
    specific_sig = 
