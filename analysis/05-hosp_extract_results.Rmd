...
if(model == "m1"){
  ...
  stanfit_object <- read_rds(paste0(
    "results/models/hosp/m2/model_run_20240315/stanfit_object.rds"
    ))
} else if(model == "m3"){
  stanfit_object <- read_rds(paste0(
...
```{r}
write_rds(pos_med, paste0("data/intermediate/hosp-", model, "_pos_med.rds"))
write_rds(stanfit_samples, paste0("data/intermediate/hosp-", model, "_stanfit_samples.rds"))
write_rds(stanfit_summary, paste0("data/intermediate/hosp-", model, "_stanfit_summary.rds"))
```
