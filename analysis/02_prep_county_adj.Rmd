...
```{r}
write_rds(county_adj_df, "../data/intermediate/county_adj_df_.rds")
write_rds(county_adj_sparse_list, "../data/intermediate/county_adj_sparse_list_.rds")
write_rds(county_fips_df, "../data/intermediate/county_fips_df_.rds")
```
