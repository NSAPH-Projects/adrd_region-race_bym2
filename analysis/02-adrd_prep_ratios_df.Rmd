...
# save tables
write_rds(exp_rates_stage1_tab, file = paste0("results/tables/adrd_expected_rates_race-specific.rds"))
write_rds(exp_rates_stage2_tab, file = paste0("results/tables/adrd_expected_rates_overall.rds"))
```
