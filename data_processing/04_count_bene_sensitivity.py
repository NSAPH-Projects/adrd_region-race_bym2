...
logging.basicConfig(filename='logs/prep_bene_county_dual.out', level=logging.INFO)
...
def main(args):
    ...
    df = df.groupby(['year', 'county', 'race', 'sex', 'age_grp', 'dual'])['n_enrollees'].sum().reset_index()
